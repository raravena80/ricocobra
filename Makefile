GOPKG_BASE := github.com/raravena80/ricocobra
...
build: workdir/ricocobra

build-native: $(GOFILES)
	go build $(GO_LDFLAGS) -o workdir/ricocobra .

workdir/ricocobra: $(GOFILES)
	GOOS=linux GOARCH=amd64 CGO_ENABLED=0 go build $(GO_LDFLAGS) -o workdir/ricocobra.linux.amd64 .
